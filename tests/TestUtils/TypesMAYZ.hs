...
newtype AppConfig = AppConfig
  { appTestParams :: TestParams
  }

newtype AppM a = AppM
  { runApp :: MReader.ReaderT AppConfig IO a
  } deriving ( Applicative
             , Functor
             , Monad
             , MonadIO.MonadIO
             , MReader.MonadReader AppConfig
             )

--------------------------------------------------------------------------------
data TestCompiledCodeScripts = TestCompiledCodeScripts
  { tccsProtocolPolicyID_Pre :: PlutusTx.CompiledCode
      (PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> ())
  , tccsProtocolValidator_Pre :: PlutusTx.CompiledCode
      (PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> ())
  , tccsScriptPolicyID_Pre :: PlutusTx.CompiledCode
      (PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> ())
  , tccsScriptValidator_Pre :: PlutusTx.CompiledCode
      (PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> ())
  , tccsSellOfferPolicyID_Pre :: PlutusTx.CompiledCode
      (PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> ())
  , tccsSellOfferValidator_Pre :: PlutusTx.CompiledCode
      (PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> ())
  , tccsBuyOrderPolicyID_Pre :: PlutusTx.CompiledCode
      (PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> ())
  , tccsBuyOrderValidator_Pre :: PlutusTx.CompiledCode
      (PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> ())
  , tccsDelegationPolicyID_Pre :: PlutusTx.CompiledCode
      (PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> ())
  , tccsDelegationValidator_Pre :: PlutusTx.CompiledCode
      (PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> ())
  , tccsInvestUnitValidator_Pre :: PlutusTx.CompiledCode
      (PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> ())
  , tccsFundPolicy_Pre :: PlutusTx.CompiledCode
      (PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> ())
  , tccsFundValidator_Pre :: PlutusTx.CompiledCode
      (PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> ())
  , tccsFundHoldingPolicyID_Pre :: PlutusTx.CompiledCode
      (PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> ())
  , tccsFundHoldingValidator_Pre :: PlutusTx.CompiledCode
      (PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> PlutusTx.BuiltinData -> ())
  }
...
data TestParams = TestParams
  ...
  , tpSellOfferPolicyID :: LedgerApiV2.MintingPolicy
  , tpSellOfferPolicyID_CS :: LedgerApiV2.CurrencySymbol
  , tpSellOfferValidator :: LedgerApiV2.Validator
  , tpSellOfferValidator_Hash :: LedgerApiV2.ValidatorHash
  ...
  , tpSellOfferAdmin :: T.WalletPaymentPKH
...
data TestEntity
  = Protocol_TestEntity
  | ProtocolTxoutRefNeeded_TestEntity
  | Fund_TestEntity
...
data PolicyTestRedeemer
  ...
  | Script_MintID_TestRedeemer
  | Script_BurnID_TestRedeemer
  | BuyOrder_MintID_TestRedeemer
  | BuyOrder_BurnID_TestRedeemer
  | Protocol_MintID_TestRedeemer
  | Delegation_MintID_TestRedeemer
  | Delegation_BurnID_TestRedeemer
  | FundHolding_MintID_TestRedeemer
  | FundHolding_BurnID_TestRedeemer
  deriving (P.Eq, P.Read, P.Show)
...
data ValidatorTestRedeemer
  ...
  | SellOffer_UpdateAskedCommissionRate_TestRedeemer
  | SellOffer_UpdateSellRestrictions_TestRedeemer
  | SellOffer_UpdateMinADA_TestRedeemer
  | SellOffer_Deposit_TestRedeemer
  | SellOffer_Withdraw_TestRedeemer
  | SellOffer_SwapFTxADA_TestRedeemer
  | SellOffer_SwapADAxFT_TestRedeemer
  | SellOffer_Emergency_TestRedeemer
  | Fund_Delete_TestRedeemer
  | Fund_DatumUpdate_TestRedeemer
  | Fund_UpdateMinADA_TestRedeemer
  | Fund_FundHoldingAdd_TestRedeemer
  | Fund_FundHoldingDelete_TestRedeemer
  | Fund_Emergency_TestRedeemer
  | Fund_Finish_TestRedeemer
  | BuyOrder_Delete_TestRedeemer
  | BuyOrder_UpdateStatus_TestRedeemer
  | BuyOrder_UpdateMinADA_TestRedeemer
  | BuyOrder_Deposit_TestRedeemer
  | BuyOrder_Withdraw_TestRedeemer
  | BuyOrder_FillOrder_TestRedeemer
  | Protocol_DatumUpdate_TestRedeemer
  | Protocol_UpdateMinADA_TestRedeemer
  | Protocol_Emergency_TestRedeemer
  | InvestUnit_ReIndexing_TestRedeemer
  | InvestUnit_UpdateMinADA_TestRedeemer
  | InvestUnit_Emergency_TestRedeemer
  | FundHolding_UpdateMinADA_TestRedeemer
  | FundHolding_Deposit_TestRedeemer
  | FundHolding_Withdraw_TestRedeemer
  ...
  | FundHolding_Emergency_TestRedeemer
  | FundHolding_Delete_TestRedeemer
  | Delegation_Delete_TestRedeemer
  | Delegation_Deposit_TestRedeemer
  | Delegation_Withdraw_TestRedeemer
  | Script_Delete_TestRedeemer
  | Generic_TestRedeemer
  deriving (P.Eq, P.Read, P.Show)
...
data TestTransactions = 
  ...
  | SellOffer_Create_Tx
  | SellOffer_UpdateStatus_Tx
  | SellOffer_UpdateAskedCommissionRate_Tx
  | SellOffer_UpdateSellRestrictions_Tx
  | SellOffer_UpdateMinADA_Tx
  | SellOffer_Deposit_Tx
  | SellOffer_Withdraw_Tx
  | SellOffer_SwapFTxADA_Tx
  | SellOffer_SwapADAxFT_Tx
  | SellOffer_Emergency_Tx
  | SellOffer_Delete_Tx
  deriving (P.Show)
