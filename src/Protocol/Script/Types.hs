...
ownVersion :: Integer
ownVersion = T.mkVersionWithDependency [ProtocolT.protocolVersion, FundT.fundVersion] scriptVersion
...
newtype PolicyParams = PolicyParams {ppProtocolPolicyID_CS :: T.CS}
