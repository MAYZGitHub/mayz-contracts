        ...
        (uTxO_With_ProtocolDatum:_) -> do
            ...
            let
                contract = PABContracts.PABProtocolUpdate T.PABProtocolUpdateParams{
                    ...
                    T.ppupRequiredMAYZForSellOffer = T.pdRequiredMAYZForSellOffer protocolDatum,
                    ...
                    T.ppupCommissionSellOffer_InBPx1e3 = T.pdCommissionSellOffer_InBPx1e3 protocolDatum,
