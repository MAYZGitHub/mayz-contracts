...
data ProtocolPABParams
    = ProtocolPABParams
          ...
          , pppTokenMAYZ_AC                :: Ledger.AssetClass
...
data ProtocolDeployParams
    = ProtocolDeployParams
          ...
          , pdpTokenMAYZ_CS                       :: LedgerApiV2.CurrencySymbol
          , pdpTokenMAYZ_TN                       :: LedgerApiV2.TokenName
...
data DeployAllPreParams
    = DeployAllPreParams
          { dapProtocolFactoryVersion           :: Integer
          , dapFundFactoryVersion               :: Integer
...
data PABProtocolEmergencyParams
...
data PABFundCollect_Protocol_CommissionParams
...
data PABFundCollect_Delegators_CommissionParams
...
data PABFundCollect_Managers_CommissionParams
...
-- exampleTokenMAYZ_AC :: Ledger.AssetClass
...
exampleFundPolicyParams =
    FundT.PolicyParams exampleCS exampleTxOutRef exampleValidatorHash exampleNFT
